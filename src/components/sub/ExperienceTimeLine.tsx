...
Work Experience              
    ...
    <ol className="mx-[30%] relative border-s border-gray-200 dark:border-gray-700">                  
        ...
        <li className="mb-10 ms-9">  
            ...
            <p className=" mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Worked in 3 different projects in 1 year 2 months</p>
        ...
        <p className="-ms-56 -mb-6 text-base font-normal text-gray-500 dark:text-gray-400">Aug 2022 - Jan 2021</p>          
            ...
            <p className="ms-3 text-base font-normal text-gray-500 dark:text-gray-400">Worked in Verizon Project for 1 year and 8 months</p>
        </li>
